...
public final class ScanActivityHandler extends Handler {
    ...
    public ScanActivityHandler(ScanMultipleActivity activity, Collection<BarcodeFormat> decodeFormats, Map<DecodeHintType, ?> baseHints, String characterSet, CameraManager cameraManager) {
    ...
    public void handleMessage(Message message) {
        if (message.what == R.id.handy_qrcode_restart_preview) {
            ...
            state = State.SUCCESS;
            activity.handleDecode((List<Result>) message.obj);

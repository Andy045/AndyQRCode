...
package com.handy.qrcode.support.multiple.camera;
...
import com.handy.qrcode.support.multiple.camera.open.CameraFacing;
import com.handy.qrcode.support.multiple.camera.open.OpenCamera;
...
final class CameraConfigurationManager {
    ...
    void setDesiredCameraParameters(OpenCamera camera, boolean safeMode) {
        ...
        CameraConfigurationUtils.setFocus(parameters, ScanConfig.KEY_AUTO_FOCUS, ScanConfig.KEY_DISABLE_CONTINUOUS_FOCUS, safeMode);

        if (!safeMode) {
            if (ScanConfig.KEY_INVERT_SCAN) {
                CameraConfigurationUtils.setInvertColor(parameters);
            }

            if (!ScanConfig.KEY_DISABLE_BARCODE_SCENE_MODE) {
                CameraConfigurationUtils.setBarcodeSceneMode(parameters);
            }

            if (!ScanConfig.KEY_DISABLE_METERING) {
    ...
    private void doSetTorch(Camera.Parameters parameters, boolean newSetting, boolean safeMode) {
        ...
        if (!safeMode && !ScanConfig.KEY_DISABLE_EXPOSURE) {

package com.com.handy.function.qrcode.utils;
...
public class QRCodeUtils {
    ...
    public static Bitmap createCode(Context context, String content, int qrcodeSize) {
        try {
            ...
            BitMatrix matrix = new MultiFormatWriter().encode(new String(content.getBytes(StandardCharsets.UTF_8), StandardCharsets.ISO_8859_1), BarcodeFormat.QR_CODE, qrcodeSize, qrcodeSize);
            // 矩阵高度
    ...
    public static Bitmap createCode(Context context, String content, Bitmap logo, int qrcodeSize) {
        try {
            ...
            // 生成二维码矩阵信息
            BitMatrix matrix = writer.encode(new String(content.getBytes(StandardCharsets.UTF_8), StandardCharsets.ISO_8859_1), BarcodeFormat.QR_CODE, qrcodeSize, qrcodeSize, hst);
            // 矩阵高度
            int width = matrix.getWidth();
            // 矩阵宽度
            int height = matrix.getHeight();
